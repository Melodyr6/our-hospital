...
import com.aaa.service.Impl.CreportServiceImpl;
...
public class CTakeConter {
    ...
    @Autowired
    private CreportServiceImpl creportServiceImpl;
    ...
    @Autowired
    CTakeMapper cTakeMapper;
    @RequestMapping("updatecondition")
    @ResponseBody
    public void updatecondition(Integer reportId, String newCondition)
    {
        ReportVo reportVo = new ReportVo();
        reportVo.setReportId(reportId);
        reportVo.setZhuan(newCondition);
